...
FOREIGN KEY (DockID) REFERENCES
Dock(DockID)
ON UPDATE CASCADE ON DELETE SET NULL,
FOREIGN KEY (RouteID) REFERENCES
Route(RouteID)
ON UPDATE CASCADE ON DELETE SET NULL
);
...
Employee(EmployeeID)
ON UPDATE CASCADE ON DELETE SET NULL,
FOREIGN KEY (BoatID) REFERENCES
Boat(BoatID)
ON UPDATE CASCADE ON DELETE SET NULL,
FOREIGN KEY (DepartDockID) REFERENCES
Dock(DockID)
ON UPDATE CASCADE ON DELETE SET NULL,
FOREIGN KEY (ArriveDockID) REFERENCES
Dock(DockID)
ON UPDATE CASCADE ON DELETE SET NULL,
FOREIGN KEY (SupervisorID) REFERENCES
Employee(EmployeeID)
...
--Mostly taken from the assignment.
--Gonna need some help with naming boats, docks, and the likes. Also maybe check if the Approved table was create correctly.--
-- -Mel --
